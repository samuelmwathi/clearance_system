                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('Student_store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="regno" type="name" placeholder="RegNo" class="form-control @error('regno') is-invalid @enderror" name="regno" required>
                        ...
                        <div class="row mb-3">
                            <label for="schl" class="col-md-4 col-form-label text-md-end">{{ __('School') }}</label>

                            <div class="col-md-6">
                                <input id="schl" type="org" placeholder="School" class="form-control @error('schl') is-invalid @enderror" name="schl" required>
